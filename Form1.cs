...
namespace Yad2_Cars
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            ElectricCar temp1 = new ElectricCar(1000, 2, true, 4, 15400, 2019, "Tesla X", 65000, 2);
            ElectricCar temp2 = new ElectricCar(670, 1, false, 4, 40000, 2017, "BMW i3", 37600, 3);
            ...
            PetrolCar temp3 = new PetrolCar(true, false, 4, 70000, 2018, "Seat Ibiza", 65000, 0);
            PetrolCar temp4 = new PetrolCar(false, true, 4, 256000, 2012, "Mercedes C200", 23400, 10);
